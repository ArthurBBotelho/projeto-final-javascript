const produtos = [
  ...
  },
  {
    id: 6,
    imagem:
      '<img src="../produtos/escrivaninha-copa/imagem/escrivaninha-copa.png">',
  ...
  },
  {
    id: 7,
    imagem:
      '<img src="../produtos/mesa-apoio-cergle/imagem/mesa-apoio-cergle.png">',
  ...
  },
  {
    id: 8,
    imagem:
      '<img src="../produtos/mesa-apoio-creation/imagem/mesa-apoio-creation.png">',
...
//--------------------------------------------------Exibindo o array de produtos na tela
...
function somaResultado() {
  ...
  let resultadoCarrinhoFeito = document.querySelector(
  ...
  document
    .getElementById("produtosCarrinho")
    .appendChild(resultadoCarrinhoRender); // Renderiza o resultado da soma do carrinho para o HTML
}
...
function adicionarProduto() {
  ...
  localStorage.setItem("carrinhoSalvo", JSON.stringify(renderCarrinho));
}
...
document.getElementById("limparCarrinho").onclick = function limparCarrinho() {
  document.getElementById("produtosCarrinho").innerHTML = carrinho.splice(
    0,
    carrinho.length
  );
